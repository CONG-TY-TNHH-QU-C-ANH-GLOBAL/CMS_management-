...
export const STATUS_BADGE: Record<string, { label: string; className: string }> = {
  published: { label: "Đã xuất bản", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  live: { label: "Đang hiển thị", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  active: { label: "Đang hoạt động", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  ready: { label: "Sẵn sàng", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  soon: { label: "Sắp ra mắt", className: "bg-sky-100 text-sky-800 border-sky-300" },
  open: { label: "Đang tuyển", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  closed: { label: "Đã đóng", className: "bg-muted text-muted-foreground border-border" },
  archived: { label: "Đã ẩn", className: "bg-muted text-muted-foreground border-border" },
  review: { label: "Chờ duyệt", className: "bg-amber-100 text-amber-800 border-amber-300" },
  in_review: { label: "Đang duyệt", className: "bg-amber-100 text-amber-800 border-amber-300" },
  draft: { label: "Bản nháp", className: "bg-muted text-muted-foreground border-border" },
  done: { label: "Hoàn tất", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  running: { label: "Đang chạy", className: "bg-sky-100 text-sky-800 border-sky-300" },
  failed: { label: "Lỗi", className: "bg-rose-100 text-rose-800 border-rose-300" },
  new: { label: "Mới", className: "bg-sky-100 text-sky-800 border-sky-300" },
  interview: { label: "Phỏng vấn", className: "bg-amber-100 text-amber-800 border-amber-300" },
  offer: { label: "Đã offer", className: "bg-emerald-100 text-emerald-800 border-emerald-300" },
  rejected: { label: "Đã từ chối", className: "bg-rose-100 text-rose-800 border-rose-300" },
};
