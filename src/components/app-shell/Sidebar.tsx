...
import {
  ...
  Layers, MessagesSquare, Star, UserRoundCog, SearchCheck, CalendarDays,
} from "lucide-react";
...
const NAV: NavGroup[] = [
  { items: [{ to: "/admin", icon: LayoutDashboard, label: "Bảng điều khiển" }] },
  {
    ...
    items: [
      ...
      { to: "/admin/content/partners", icon: Handshake, label: "Đối tác" },
      { to: "/admin/content/leadership", icon: UserRoundCog, label: "Leadership" },
      ...
      { to: "/admin/content/events", icon: CalendarDays, label: "Event", matchPrefix: true },
