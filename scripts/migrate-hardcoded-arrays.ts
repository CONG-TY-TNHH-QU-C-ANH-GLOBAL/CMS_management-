...
// Imports the landing translation dictionary to resolve keys → text per locale.
//
...
import { loadLandingTranslations, type LandingTranslations } from "./lib/loadLandingTranslations";
...
type Translations = LandingTranslations;
